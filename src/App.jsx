      ...
      <div className="w-full overflow-hidden">
        <nav className="bg-[#FFF7ED] flex justify-center items-center px-6 sm:px-16">
          <div className="w-full xl:max-w-[1280px] flex justify-between items-center py-4">
            ...
            <div>
              <Link to="/about" className="font-inter font-semibold text-[16px] leading-[22.92px] mr-4 md:mr-8" element = {<About />}>About</Link>
              <Link to="/Vans" className="font-inter font-semibold text-[16px] leading-[22.92px]" element = {<Vans />}>Vans</Link>
            </div>
          </div>
        </nav>
        <Routes>
